...
<?php
  ...
  Class Student{
    static $fields = array("idStudent", "name", "lastname", "birthdate", "curp", "address");
    ...
    public function displayAllStudents($result){
      ...
      while($row = $result->fetch_assoc()) {
        ...
        echo "<td>
              ...
              <!-- Modify -->
              <div class='modal fade' id='modifyModal$id' tabindex='-1' role='dialog' aria-labelledby='modifyModal$id' aria-hidden='true'>
                    <div class='modal-dialog modal-dialog-scrollable' role='document'>
                          <div class='modal-content'>
                                ...
                                <div class='input-group mb-3'>
                                      <input name='name' type='text' class='form-control'  aria-describedby='basic-addon3' value='$name'>
                                </div>
                                <label for='basic-url'>Apellidos</label>
                                <div class='input-group mb-3'>
                                      <input name='lastname' type='text' class='form-control'  aria-describedby='basic-addon3' value='$lastname'>
                                </div>
                                <label for='basic-url'>Fecha de Nacimiento</label>
                                <div class='input-group mb-3'>
                                      <input name='birthdate' type='date' class='form-control'  aria-describedby='basic-addon3' value='$birthdate'>
                                </div>
                                <label for='basic-url'>Lugar de Nacimiento</label>
                                <div class='input-group mb-3'>
                                      <input name='birthplace' type='text' class='form-control'  aria-describedby='basic-addon3' value='$birthplace'>
                                </div>
                                <label for='basic-url'>CURP</label>
                                <div class='input-group mb-3'>
                                      <input name='curp' type='text' class='form-control'  aria-describedby='basic-addon3' value='$curp'>
                                </div>
